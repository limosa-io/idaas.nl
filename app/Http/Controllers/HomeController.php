...
class HomeController extends Controller
{
    ...
    const COOKIE_FRAME_INFO = 'frame-info';
    ...
    public function render($view = 'login', $data = [], Request $request)
    {
        ...
        // With Vue development/webpack server, it will make use of eval and unsafe-inline without nonce. Therefore, only enable this for production
